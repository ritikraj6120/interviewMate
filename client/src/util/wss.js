    ...
    if (isAuthor) {
        ...
        if (userChatHistory) {
            ...
            const newChatHistory = [
                ...chatHistory.filter((h) => h.socketId !== receiverSocketId),
                newUserChatHistory,
            ];
        ...
        if (userChatHistory) {
            ...
            const newChatHistory = [
                ...chatHistory.filter((h) => h.socketId !== authorSocketId),
                newUserChatHistory,
            ];
            dispatch(setChatHistory(newChatHistory));
        } else {
